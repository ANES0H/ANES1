...
@Client.on_message(command(["start", f"start@Musictsh_bot"]) & filters.private & ~filters.edited)
...
@Client.on_message(
    command(["فحص", f"alive@Musictsh_bot"]) & filters.group & ~filters.edited
)
...
@Client.on_message(command(["بنك", f"ping@Musictsh_bot"]) & ~filters.edited)
...
@Client.on_message(command(["الحاله", f"uptime@Musictsh_bot"]) & ~filters.edited)
...
@Client.on_message(command(["Kstop", f"Kstop@Musictsh_bot", "تعطيل المميزات"]) & ~filters.edited)
...
@Client.on_message(command(["Kstart", f"Kstart@Musictsh_bot"]) & ~filters.edited)
@authorized_users_only

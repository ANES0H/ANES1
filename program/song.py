...
@Client.on_message(command(["song", f"song@Musictsh_bot"]) & ~filters.edited)
def songg(_, message):
    ...
    try:
        ...
        buttons = [[InlineKeyboardButton("𝗌𝗈𝗎𝗋𝖼𝖾 𝗆as", url="t.me/S8Y8S")]]
...
@Client.on_message(
    command(["تحميل", f"vsong@Musictsh_bot", "video", f"video@Musictsh_bot"]) & ~filters.edited
)
